Gem::Specification.new do |spec|
  spec.name          = "shrine-gdrive_storage_cmptbl"
  spec.version       = "0.5.1"
  spec.authors       = ["edwardsharp"]
  spec.email         = ["edward@edwardsharp.net"]
  spec.date          = '2018-04-04'
  spec.summary       = "Provides Google Drive Storage for Shrine. (Compatible with google-cloud-storage)"
  ...
  spec.homepage      = "https://github.com/nikharR/shrine-gdrive_storage"
  spec.license       = "MIT"
  ...
  spec.add_dependency 'google-api-client', '~> 0.26.0'
